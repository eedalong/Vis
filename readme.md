# 数据可视化作业报告
袁秀龙 2019214500 石耕源 2019312657 秦睿 2020312642
## 一、数据可视化背景
本次作业项目中我们使用某制药厂商各个经销商脱敏后2017-2019年产品A、B的销售、采购、发货记录数据。进行销售数据的分析以及可视化。在本次作业中我们可视化了各个药品批次的销售流向以及检测并可视化出经销数据中的异常与风险。在风险检测中，我们着重检测并可视化了经销商的倒货刷业绩风险。即数个经销商在短时间内互相进行销售同一个批次的药品，
此种行为我们认为是经销商倒货行为，我们检测并告警出该风险并可视化展示。
...
### 2.3 药品流向检索
本实验中制定药品批次号以及销售起点之后，我们可以实现对于该批次药品之后的流向情况的检索以及可视化。
