        ...
        tooltip: {
            ...
            formatter: function (val){
                ...
                if (val.componentSubType === "effectScatter"){
                    return "经销商:" + val.data.name +"<br> 经销商等级： " + val.data.value[2];
                }
...
function getData(){
    ...
    $.ajax({
        type: "GET",
        url: 'http://localhost:8000/risk/cycle/',
        dataType: 'json',
        crossDomain:true,
        data: {
            // batch_number:"BJ45743",
        ...
        success: function (data) {
            let riskPHCode = data.data[data.data.length-1]
